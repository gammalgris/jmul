 ...
 */
public class Xml2CompositeMapRule extends TransformationRuleBase {
     ...
     *        a rule priority
     */
    public Xml2CompositeMapRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (!Document.class.isInstance(target) && Node.class.isInstance(target)) {
            ...
            return XmlParserHelper.matchesXmlElement(objectElement, OBJECT_ELEMENT) &&
                   XmlParserHelper.hasXmlSubelements(objectSubelements) &&
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        for (Node entryElement : objectSubelements.getSubelements(ENTRY_ELEMENT)) {
