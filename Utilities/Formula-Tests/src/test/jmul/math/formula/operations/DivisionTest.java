...
public class DivisionTest {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { 1, new int[] { 2, 2 } });
        parameters.add(new Object[] { -1, new int[] { 2, -2 } });
        parameters.add(new Object[] { -1, new int[] { -2, 2 } });
        parameters.add(new Object[] { 1, new int[] { 2, 2, 2 } });
        parameters.add(new Object[] { -1, new int[] { 2, -2, 2 } });
        parameters.add(new Object[] { 0, new int[] { 2, 2, 2, 2 } });
        parameters.add(new Object[] { 0, new int[] { 2, -2, 2, -2 } });
     ...
     *        all operands
     */
    public DivisionTest(int anExpectedResult, int... someOperands) {
