...
public class SubtractionTest {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { 0, new int[] { 1, 1 } });
        parameters.add(new Object[] { 2, new int[] { 1, -1 } });
        parameters.add(new Object[] { -2, new int[] { -1, 1 } });
        parameters.add(new Object[] { -1, new int[] { 1, 1, 1 } });
        parameters.add(new Object[] { -2, new int[] { 1, 1, 1, 1 } });
     ...
     *        all operands
     */
    public SubtractionTest(int anExpectedResult, int... someOperands) {
