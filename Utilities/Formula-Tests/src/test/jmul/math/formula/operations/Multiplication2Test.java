...
public class Multiplication2Test {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { 4, new Operand[] { new Constant(2), new Constant(2) } });
        parameters.add(new Object[] { -4, new Operand[] { new Constant(2), new Constant(-2) } });
        parameters.add(new Object[] { -4, new Operand[] { new Constant(-2), new Constant(2) } });
        parameters.add(new Object[] { 8, new Operand[] { new Constant(2), new Constant(2), new Constant(2) } });
        parameters.add(new Object[] { -8, new Operand[] { new Constant(2), new Constant(-2), new Constant(2) } });
        parameters.add(new Object[] { 16,
     ...
     *        all operands
     */
    public Multiplication2Test(int anExpectedResult, Operand... someOperands) {
