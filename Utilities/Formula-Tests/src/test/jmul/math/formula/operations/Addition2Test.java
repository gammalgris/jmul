...
public class Addition2Test {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { 2, new Operand[] { new Constant(1), new Constant(1) } });
        parameters.add(new Object[] { 0, new Operand[] { new Constant(1), new Constant(-1) } });
        parameters.add(new Object[] { 0, new Operand[] { new Constant(-1), new Constant(1) } });
        parameters.add(new Object[] { 3, new Operand[] { new Constant(1), new Constant(1), new Constant(1) } });
     ...
     *        all operands
     */
    public Addition2Test(int anExpectedResult, Operand... someOperands) {
