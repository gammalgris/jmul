...
import test.jmul.persistence.organisation.OrganisationDetails;
 ...
 */
public interface DepartmentDetails extends OrganisationDetails {
     ...
     *         job title
     */
    float calculateTotalSalaries(String aTitle);
