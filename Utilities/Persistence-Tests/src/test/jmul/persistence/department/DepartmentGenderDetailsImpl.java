...
package test.jmul.persistence.department;
...
import test.jmul.persistence.employee.EmployeeList;
...
public class DepartmentGenderDetailsImpl implements DepartmentGenderDetails {
     ...
     */
    @MapInformations(declaredKeyType = String.class, declaredValueType = Map.class)
    private Map<String, Map<String, EmployeeList>> sortedWorkforce;

    /**
     * The default constructor.
     */
    public DepartmentGenderDetailsImpl() {

        unsortedWorkforce = new ArrayList<Employee>();
        sortedWorkforce = new HashMap<String, Map<String, EmployeeList>>();
    }
    ...
    public void addEmployee(Employee anEmployee) {
        ...
        if (genderSubsets == null) {
            ...
            genderSubsets = new HashMap<String, EmployeeList>();
     ...
     *        the department's workforce
     */
    public void setSortedWorkforce(Map<String, Map<String, EmployeeList>> sortedWorkforce) {
     ...
     * @return the department's workforce
     */
    public Map<String, Map<String, EmployeeList>> getSortedWorkforce() {
