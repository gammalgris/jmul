...
package test.jmul.persistence.company;
...
import test.jmul.persistence.payroll.PayrollList;
import test.jmul.persistence.payroll.PayrollListImpl;
import test.jmul.persistence.payroll.PayrollListImpl2;
...
public class CompanyDetailsImpl3 implements CompanyDetails {
     ...
     */
    public CompanyDetailsImpl3() {

        employees = new ArrayList<Employee>();
        payrollList = new PayrollListImpl2();
    }
