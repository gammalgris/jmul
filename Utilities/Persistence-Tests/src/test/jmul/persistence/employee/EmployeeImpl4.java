...
import test.jmul.persistence.person.PersonImpl;
...
public class EmployeeImpl4 implements Employee {
     ...
     */
    public EmployeeImpl4(String aFirstName, String aLastName, String aBirthdate, String aGender, float aSalary,
                         String aTitle) {
