...
import test.jmul.datatypes.scenario06.Company;
import test.jmul.datatypes.scenario06.EmployeeImpl;
 ...
 */
@ModuleTest
public class Scenario06SerializationTest extends SerializationTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ".\\Test\\Serialization\\Scenario06";
