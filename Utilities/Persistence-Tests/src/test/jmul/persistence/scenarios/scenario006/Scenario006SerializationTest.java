...
package test.jmul.persistence.scenarios.scenario006;
...
import test.jmul.datatypes.scenarios.scenario006.Company;
import test.jmul.datatypes.scenarios.scenario006.EmployeeImpl;
 ...
 */
@ModuleTest
public class Scenario006SerializationTest extends SerializationTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ROOT_DIRECTORY + "Serialization\\Scenario-006";
    ...
    private static void compareCompanies(Company c1, Company c2) {
        ...
        assertEquals("", c1.getCompanyName(), c2.getCompanyName());
