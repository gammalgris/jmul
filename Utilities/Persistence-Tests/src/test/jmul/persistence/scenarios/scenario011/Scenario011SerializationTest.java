...
package test.jmul.persistence.scenarios.scenario011;
 ...
 */
@ModuleTest
public class Scenario011SerializationTest extends SerializationTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ROOT_DIRECTORY + "Serialization\\Scenario-011";
