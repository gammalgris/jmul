...
package test.jmul.persistence.scenarios.scenario014;
 ...
 */
@ModuleTest
public class Scenario014SerializationTest extends SerializationTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ROOT_DIRECTORY + "Serialization\\Scenario-014";
