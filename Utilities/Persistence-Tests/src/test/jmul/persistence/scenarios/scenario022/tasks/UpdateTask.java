...
/**
 * An implementation of a task that updates a specific data entry.
 *
...
public class UpdateTask extends TaskBase {
     ...
     */
    public UpdateTask(PersistenceContainer<Person> aContainer, TaskResultCollector aCollector, long aSleepTime, ID anID,
    ...
    /**
     * The actual update operation is implemented here.
     */
    @Override
    void performTask() {
        ...
        try {
            ...
            Person person = getContainer().get(id);
    ...
    private static String createMessage(ID anID, Throwable anException) {
        ...
        buffer.append("Trying to update the data entry with the ID \"");
        buffer.append(anID);
        buffer.append("\"");
