...
/**
 * An implementation of a task that reads a specific data entry.
 *
...
public class ReadTask extends TaskBase {
     ...
     */
    public ReadTask(PersistenceContainer<Person> aContainer, TaskResultCollector aCollector, long aSleepTime, ID anID,
    ...
    /**
     * The actual read operation is implemented here.
     */
    @Override
    void performTask() {
    ...
    private static String createMessage(ID anID, Throwable anException) {
        ...
        buffer.append("Trying to read data entry with the ID \"");
        buffer.append(anID);
        buffer.append("\"");
