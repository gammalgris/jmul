...
package test.jmul.persistence.scenarios.scenario003;
...
import test.jmul.datatypes.scenarios.scenario003.Person;
 ...
 */
@ModuleTest
public class Scenario003SerializationTest extends SerializationTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ROOT_DIRECTORY + "Serialization\\Scenario-003";
    ...
    private static void compareDirtyFlag(Person p1, Person p2) {
        ...
        assertNotEquals(p1.isDirtyFlag(), p2.isDirtyFlag());
    }
