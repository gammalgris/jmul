...
package test.jmul.persistence.scenarios.scenario017;
 ...
 */
@ModuleTest
public class Scenario017PersistenceTest extends PersistenceTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ROOT_DIRECTORY + "Serialization\\Scenario-017";
