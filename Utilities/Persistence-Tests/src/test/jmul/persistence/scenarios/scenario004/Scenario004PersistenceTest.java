...
package test.jmul.persistence.scenarios.scenario004;
 ...
 */
@ModuleTest
public class Scenario004PersistenceTest extends PersistenceTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ROOT_DIRECTORY + "Persistence\\Scenario-004";
