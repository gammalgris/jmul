...
package test.jmul.persistence.scenarios.scenario015;
...
import test.jmul.datatypes.scenarios.scenario014.Person;
 ...
 */
@ModuleTest
public class Scenario015SerializationTest extends SerializationTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ROOT_DIRECTORY + "Serialization\\Scenario-015";
