 ...
 */
public class ImprovedTestPersistenceLoad {
     ...
     */
    public ImprovedTestPersistenceLoad() {

        ResourceBundle bundle = ResourceBundle.getBundle(RESOURCE_BUNDLE_NAME);

        String drive = bundle.getString(DRIVE_KEY);
        ...
        persistenceManager =
            new PersistenceContainerImpl<DepartmentGenderDetails>(DepartmentGenderDetails.class,
    ...
    public static void main(String[] args) {
        ...
        ImprovedTestPersistenceLoad test = new ImprovedTestPersistenceLoad();
        test.startTest();
    }
