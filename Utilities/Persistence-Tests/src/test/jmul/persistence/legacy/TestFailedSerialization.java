...
import test.jmul.datatypes.company.CompanyDetailsImpl2;
import test.jmul.datatypes.department.DepartmentDetails;
import test.jmul.datatypes.department.DepartmentDetailsImpl;
import test.jmul.datatypes.department.DepartmentGenderDetails;
import test.jmul.datatypes.department.DepartmentGenderDetailsImpl;
import test.jmul.datatypes.employee.Employee;
import test.jmul.datatypes.employee.EmployeeImpl;
import test.jmul.datatypes.employee.EmployeeImpl2;
import test.jmul.datatypes.employee.EmployeeImpl3;
import test.jmul.datatypes.employee.EmployeeImpl4;
import test.jmul.datatypes.employee.EmployeeImpl5;
import test.jmul.datatypes.employee.EmployeeImpl6;
import test.jmul.datatypes.person.Person;
import test.jmul.datatypes.person.PersonImpl2;
import test.jmul.datatypes.person.PersonImpl3;
import test.jmul.datatypes.person.PersonImpl4;
