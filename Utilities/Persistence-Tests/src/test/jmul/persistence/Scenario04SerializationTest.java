...
import test.jmul.datatypes.interfaces.Person;
import test.jmul.datatypes.scenario04.PersonImpl;
 ...
 */
@ModuleTest
public class Scenario04SerializationTest extends SerializationTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ".\\Test\\Serialization\\Scenario04";
