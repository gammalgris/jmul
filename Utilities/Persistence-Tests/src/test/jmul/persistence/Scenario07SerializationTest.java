...
import test.jmul.datatypes.scenario07.Company;
import test.jmul.datatypes.scenario07.EmployeeImpl;
 ...
 */
@ModuleTest
public class Scenario07SerializationTest extends SerializationTestBase {

    /**
     * A base directory for tests.
     */
    private static final String BASEDIR = ".\\Test\\Serialization\\Scenario07";
