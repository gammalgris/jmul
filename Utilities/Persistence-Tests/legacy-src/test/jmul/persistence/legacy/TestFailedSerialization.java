...
import test.jmul.datatypes.legacy.company.CompanyDetailsImpl2;
import test.jmul.datatypes.legacy.department.DepartmentDetails;
import test.jmul.datatypes.legacy.department.DepartmentDetailsImpl;
import test.jmul.datatypes.legacy.department.DepartmentGenderDetails;
import test.jmul.datatypes.legacy.department.DepartmentGenderDetailsImpl;
import test.jmul.datatypes.legacy.employee.Employee;
import test.jmul.datatypes.legacy.employee.EmployeeImpl;
import test.jmul.datatypes.legacy.employee.EmployeeImpl2;
import test.jmul.datatypes.legacy.employee.EmployeeImpl3;
import test.jmul.datatypes.legacy.employee.EmployeeImpl4;
import test.jmul.datatypes.legacy.employee.EmployeeImpl5;
import test.jmul.datatypes.legacy.employee.EmployeeImpl6;
import test.jmul.datatypes.legacy.person.Person;
import test.jmul.datatypes.legacy.person.PersonImpl2;
import test.jmul.datatypes.legacy.person.PersonImpl3;
import test.jmul.datatypes.legacy.person.PersonImpl4;
