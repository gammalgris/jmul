...
/**
 * This interface describes a GUI action (the action which results from interacting with a GUI component).
...
public interface Action extends Runnable {
     ...
     */
    boolean matchesAction(ActionEvent e);

    /**
     * Performs this action (i.e. starts it asynchronously)
     *
     * @param e
     */
