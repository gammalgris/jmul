...
/**
 * This enumeration contains various XML markups that define a test document structure.
 *
 * @author Kristian Kutin
 */
public enum TestFileMarkups implements XmlMarkup {


    TEST_ATTRIBUTE("test", XML_ATTRIBUTE),

    TEST_NODE("test", XML_ELEMENT),
    ROOT_NODE("root", XML_ELEMENT), ;
     ...
     */
    private TestFileMarkups(String aName, XmlMarkupType aType) {
