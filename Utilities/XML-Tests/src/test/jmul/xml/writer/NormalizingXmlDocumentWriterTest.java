...
import jmul.xml.writer.NormalizingXmlDocumentWriterImpl;
...
public class NormalizingXmlDocumentWriterTest {
    ...
    public void setUp() {
        ...
        writer = new NormalizingXmlDocumentWriterImpl();
    ...
    public void testWriteDocument() {
        ...
        String filename = "./testdata-xml/normalized-test-output.xml";
