...
/**
 * The class contains tests to check the normalization of number strings. The utility methods
...
public class NormalizationInvalidParameterstest {
     ...
     */
    public NormalizationInvalidParameterstest(String aString, Class anExceptionType) {
    ...
    public void testNormalization() {
        ...
        try {
            ...
            NotationHelper.normalizeString(string);
