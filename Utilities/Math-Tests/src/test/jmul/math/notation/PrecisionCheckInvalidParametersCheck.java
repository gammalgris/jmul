 ...
 * correctly. The utility methods are invoked with invalid parameters.
 *
 * @author Kristian Kutin
 */
@UnitTest
@RunWith(Parameterized.class)
public class PrecisionCheckInvalidParametersCheck {
     ...
     */
    public PrecisionCheckInvalidParametersCheck(String aString, Class anExceptionType) {
    ...
    public void testCheckPrecision() {
        ...
        try {
            ...
            NotationHelper.checkPrecision(string);
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { "9223372036854775808", UnsupportedOperationException.class });
        parameters.add(new Object[] { "-9223372036854775809", UnsupportedOperationException.class });
