 ...
 * the scientific notation. The utility methods are invoked with invalid parameters.
 *
 * @author Kristian Kutin
 */
@UnitTest
@RunWith(Parameterized.class)
public class ExpandScientificNotationInvalidParametersTest {
     ...
     */
    public ExpandScientificNotationInvalidParametersTest(String aString, Class anExceptionType) {
    ...
    public void testExpansion() {
        ...
        try {
            ...
            NotationHelper.expandScientificNotation(string);
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { "-1", IllegalArgumentException.class });
        parameters.add(new Object[] { "1.0", IllegalArgumentException.class });
        parameters.add(new Object[] { "1,0", IllegalArgumentException.class });
        parameters.add(new Object[] { "-1.0", IllegalArgumentException.class });
        parameters.add(new Object[] { "-1,0", IllegalArgumentException.class });
        parameters.add(new Object[] { "1.0E", IllegalArgumentException.class });
        parameters.add(new Object[] { "1,0E", IllegalArgumentException.class });
        parameters.add(new Object[] { "-1.0E", IllegalArgumentException.class });
        parameters.add(new Object[] { "-1,0E", IllegalArgumentException.class });
        parameters.add(new Object[] { "1.0E+", IllegalArgumentException.class });
