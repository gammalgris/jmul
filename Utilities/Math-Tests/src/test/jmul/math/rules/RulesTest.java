...
public class RulesTest {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { createMinimumValueRule(3), 3 });
        parameters.add(new Object[] { createMinimumValueRule(3), 4 });

        parameters.add(new Object[] { createMaximumValueRule(18), 17 });
        parameters.add(new Object[] { createMaximumValueRule(18), 18 });

        parameters.add(new Object[] { createEqualValueRule(18), 18 });

        parameters.add(new Object[] { createRuleSet(), 18 });
        parameters.add(new Object[] { createRuleSet(createMinimumValueRule(3), createMaximumValueRule(18)), 3 });
        parameters.add(new Object[] { createRuleSet(createMinimumValueRule(3), createMaximumValueRule(18)), 12 });
        parameters.add(new Object[] { createRuleSet(createMinimumValueRule(3), createMaximumValueRule(18)), 18 });
     ...
     * @param aValue
     */
    public RulesTest(Rule aRule, int aValue) {
    ...
    public void checkValue() {
        ...
        assertTrue(createErrorMessage(rule, value), result);
    }
