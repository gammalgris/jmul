...
import jmul.document.markdown.content.node.TextNode;
 ...
 */
public class TextBlock2MarkdownRule extends TransformationRuleBase {
     ...
     *        a rule priority
     */
    public TextBlock2MarkdownRule(String anOrigin, String aDestination, int aPriority) {
