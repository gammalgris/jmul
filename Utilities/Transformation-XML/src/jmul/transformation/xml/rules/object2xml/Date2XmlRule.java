...
import static jmul.transformation.xml.rules.TransformationConstants.DEFAULT_DATE_FORMAT;
...
/**
 * A transformation rule which handles the date type.
 *
...
public class Date2XmlRule extends TransformationRuleBase {
     ...
     *        a rule priority
     */
    public Date2XmlRule(String anOrigin, String aDestination, int aPriority) {
