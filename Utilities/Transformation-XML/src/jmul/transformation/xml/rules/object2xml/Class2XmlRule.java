 ...
 */
public class Class2XmlRule extends TransformationRuleBase {
     ...
     *        a rule priority
     */
    public Class2XmlRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        return Class.class.isInstance(someParameters.getObject());
    }
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        element.setAttribute(VALUE_ATTRIBUTE.getTagName(), clazz.getCanonicalName());
