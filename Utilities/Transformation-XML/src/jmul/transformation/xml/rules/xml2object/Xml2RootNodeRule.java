 ...
 */
public class Xml2RootNodeRule extends TransformationRuleBase {
     ...
     *        a rule priority
     */
    public Xml2RootNodeRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (!Document.class.isInstance(target) && Node.class.isInstance(target)) {
            ...
            return XmlParserHelper.matchesXmlElement(objectElement, OBJECT_ELEMENT) &&
                   !XmlParserHelper.existsXmlAttribute(objectElement, ID_ATTRIBUTE) &&
