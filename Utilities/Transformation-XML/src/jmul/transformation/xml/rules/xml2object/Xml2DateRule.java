 ...
 */
public class Xml2DateRule extends TransformationRuleBase {

    /**
     * A class name.
     */
    private static final String EXPECTED_TYPE_NAME = Date.class.getName();
     ...
     *        a rule priority
     */
    public Xml2DateRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        XmlParserHelper.assertExistsXmlAttribute(objectElement, FORMAT_ATTRIBUTE);
        ...
        String formatString = XmlParserHelper.getXmlAttributeValue(objectElement, FORMAT_ATTRIBUTE);
        ...
        Object object = factory.newInstance(type, valueString, formatString);
