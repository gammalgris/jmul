 ...
 */
public class Xml2UninitializedRule extends TransformationRuleBase {
     ...
     *        a rule priority
     */
    public Xml2UninitializedRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (!Document.class.isInstance(target) && Node.class.isInstance(target)) {
            ...
            String classname = XmlParserHelper.getXmlAttributeValue(objectElement, TYPE_ATTRIBUTE);
