 ...
 */
public class Xml2FieldRule extends TransformationRuleBase {

    /**
     * A class name.
     */
    private static final String EXPECTED_TYPE_NAME = Field.class.getName();
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        try {
            ...
            String message =
                TextHelper.concatenateStrings("The class ", className, " doesn't have a field with the name ",
                                              fieldName, "!");
            throw new TransformationException(message, e);
        }
