...
public interface ClassDefinition extends ClassIdentifier {
     ...
     *         specified criteria
     */
    Method getMethod(String aMethodname, List<ClassDefinition> aMethodSignature) throws NoSuchMethodException;
     ...
     *         specified criteria
     */
    Method getMethod(String aMethodname, List<ClassDefinition> aMethodSignature,
     ...
     *         specified criteria
     */
    Method getAccessor(String aPrefix, String aFieldname) throws NoSuchMethodException;
     ...
     *         specified criteria
     */
    Method getAccessor(String aPrefix, String aFieldname, boolean recurse) throws NoSuchMethodException;
     ...
     *         specified criteria
     */
    Field getField(String aFieldname, boolean recurse) throws NoSuchFieldException;
