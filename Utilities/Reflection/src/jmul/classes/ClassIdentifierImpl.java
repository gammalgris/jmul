...
class ClassIdentifierImpl implements ClassIdentifier {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null) {
            ...
            boolean defaultClasspath =
                this.isLocatedOnDefaultClasspath() && other.isLocatedOnDefaultClasspath();
            boolean sameAlternateClasspath =
                this.isLocatedOnAlternateClasspath() &&
                other.isLocatedOnAlternateClasspath() &&
    ...
    public int hashCode() {
        ...
        tmp =
(getAlternateClasspath() != null ? getAlternateClasspath().hashCode() : 0);
        hash = 23 * hash + tmp;
    ...
    public String toString() {
        ...
        StringConcatenator representation =
            new StringConcatenator(getClassname());
