...
import jmul.classes.filter.MethodFilter;
import jmul.classes.filter.MethodNameFilter;
import jmul.classes.filter.PublicMethodFilter;
import jmul.classes.filter.SignatureLengthFilter;
import jmul.classes.signature.SignatureMatcher;
import jmul.classes.signature.SignatureMatcherImpl;
...
class ClassDefinitionImpl implements ClassDefinition {
     ...
     */
    ClassDefinitionImpl(ClassIdentifier anIdentifier, Class aType,
                        ClassDefinition aCorrespondingPrimitiveType) {
    ...
    private boolean implementsInterface(Class anInterface, boolean recurse) {
        ...
        if (!anInterface.isInterface()) {
            ...
            StringConcatenator message =
                new StringConcatenator("The specified class ", anInterface,
                                       " is no interface!");
        ...
        while (loop) {
            ...
            Collection<Class> implementedInterfaces =
                determineInterfaces(contemplatedClass, recurse);
    ...
    private boolean extendsInterface(Class anInterface, boolean recurse) {
        ...
        Collection<Class> parentInterfaces =
            determineParentInterfaces(contemplatedInterface, recurse);
        boolean found = false;
    ...
    public boolean extendsClass(ClassDefinition aParentClass,
        ...
        if (isInterface()) {
            ...
            StringConcatenator message =
                new StringConcatenator("This class (", this,
     ...
     *         specified criteria
     */
    public Method getMethod(String aMethodname,
    ...
    public Method getMethod(String aMethodname,
        ...
        try {
            ...
            identifiedMethod =
                    probedClass.getMethod(aMethodname, nativeSignature);
            ...
            Collection<Method> filteredMethods =
                getMethods(aMethodname, aMethodSignature.size(), recurse);
            ...
            for (Method method : filteredMethods) {
                ...
                List<ClassDefinition> requiredSignature =
                ...
                try {
                    ...
                    StringConcatenator message =
                        new StringConcatenator("Method signature contains an unknown class:");
                ...
                found =
                        matcher.matchingSignatures(requiredSignature, aMethodSignature);
            ...
            if (!found) {
                StringConcatenator message =
                    new StringConcatenator("The class ", getType().getName(),
                                           " doesn't possess a method \"",
                                           aMethodname, " and the signature ",
                                           aMethodSignature, "!");
     ...
     *         specified criteria
     */
    public Method getAccessor(String aPrefix,
     ...
     *         specified criteria
     */
    public Method getAccessor(String aPrefix, String aFieldname,
                              boolean recurse) throws NoSuchMethodException {
        ...
        try {
            ...
            StringConcatenator message =
                new StringConcatenator("No field with the specified name \"",
                                       aFieldname, "\" exists!");
            throw new NoSuchMethodException(message.toString());
        }
        ...
        if (AccessorHelper.SETTER_PREFIX.equals(aPrefix)) {
            ...
            Collection<Method> foundMethods =
                getMethods(methodname, 1, recurse);

            if (foundMethods.size() == 0) {

                StringConcatenator message =
                    new StringConcatenator("No setter method with the name ",
                                           methodname, " was found!");
                throw new NoSuchMethodException(message.toString());
            ...
            Collection<Method> foundMethods =
                getMethods(methodname, 0, recurse);

            if (foundMethods.size() == 0) {

                StringConcatenator message =
                    new StringConcatenator("No getter method with the name ",
                                           methodname, " was found!");
                throw new NoSuchMethodException(message.toString());
        ...
        StringConcatenator message =
            new StringConcatenator("Unknown prefix \"", aPrefix, "\"!");
        throw new IllegalArgumentException(message.toString());
    }
     ...
     *         parameters
     */
    private Collection<Method> getMethods(String aMethodname,
    ...
    public boolean equalsClass(ClassDefinition aClass) {
        ...
        if (aClass.isInterface()) {
            ...
            StringConcatenator message =
                new StringConcatenator("The specified class ", aClass,
                                       " is an interface!");
            throw new IllegalArgumentException(message.toString());
        }
        ...
        if (isInterface()) {
            ...
            StringConcatenator message =
                new StringConcatenator("This class ", getType(),
                                       " is an interface!");
            throw new UnsupportedOperationException(message.toString());
        }
     ...
     */
    private static boolean equalClasses(ClassDefinition firstClass,
                                        ClassDefinition secondClass) {

        boolean onDefaultClasspath =
            firstClass.isLocatedOnDefaultClasspath() &&
            secondClass.isLocatedOnDefaultClasspath();
        boolean onAlternateClasspath =
            firstClass.isLocatedOnAlternateClasspath() &&
            secondClass.isLocatedOnAlternateClasspath();
        ...
        if (onDefaultClasspath) {
            ...
            boolean sameClasspath =
                firstClass.getAlternateClasspath().equals(secondClass.getAlternateClasspath());

            if (sameClasspath) {

                equal =
                        equalClasses(firstClass.getType(), secondClass.getType());
            }
        }
     ...
     */
    private static boolean equalClassnames(String firstClassname,
     ...
     */
    private static Collection<Class> determineInterfaces(Class aClass,
                                                         boolean recurse) {
        ...
        while (loop) {
            ...
            for (Class foundInterface : implementedInterfaces) {
                ...
                if (recurse) {
                    ...
                    allImplementedInterfaces.addAll(determineParentInterfaces(foundInterface,
                                                                              recurse));
                }
            }
     ...
     */
    private static Collection<Class> determineParentInterfaces(Class anInterface,
                                                               boolean recurse) {
        ...
        for (Class foundInterface : foundInterfaces) {
            ...
            if (recurse) {
                ...
                parentInterfaces.addAll(determineParentInterfaces(foundInterface,
                                                                  recurse));
            }
        }
     ...
     *         specified criteria
     */
    public Field getField(String aFieldname,
        ...
        if (foundField == null) {
            ...
            String message =
                "No field with the specified name could be found!";
