...
public class NormalizeJavaStringInvalidParametersTest {
     ...
     */
    public NormalizeJavaStringInvalidParametersTest(String anInput, Class theExpectedExceptionClass) {
    ...
    public void testNormalizeXmlString() {
        ...
        try {
            ...
            TextNormalizationHelper.toNormalizedJavaString(input);
