...
public class IdentifySeparatorTest {
     ...
     */
    public IdentifySeparatorTest(String aString, String aSeparator, int anExpectedResult) {
    ...
    public void testStringConcatenator() {
        ...
        int actualResult = TextHelper.nextSeparatorIndex(string, separator);
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { "A;B;C;D", ";", 1 });
        parameters.add(new Object[] { "ABCD", ";", -1 });
        parameters.add(new Object[] { "ABCD;", ";", 4 });
