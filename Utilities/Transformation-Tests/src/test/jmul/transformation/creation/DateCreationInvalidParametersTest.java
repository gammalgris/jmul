...
/**
 * This class tests the date creation with invalid parameters.
 *
 * @author Kristian Kutin
 */
@UnitTest
@RunWith(Parameterized.class)
public class DateCreationInvalidParametersTest {
     ...
     *        a date pattern
     */
    public DateCreationInvalidParametersTest(String aClassname, String anInputValue, String aDatePattern) {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { "java.util.Date", null, "dd.MM.yyyy" });
        parameters.add(new Object[] { "java.util.Date", "01.01.2018", null });
