...
/**
 * A generic implementation for a message creator.
 *
 * @author Kristian Kutin
 */
public class GenericMessageCreator extends MessageCreatorBase {
    ...
    public String newMessage(Object anObject) {
        ...
        return TextHelper.concatenateStrings(anObject.getClass().getName(), "(", anObject.toString(), ")");
    }
