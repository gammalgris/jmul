...
public class ValidStateTransitionsTest {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { INITIALIZATION, ERROR });

        parameters.add(new Object[] { INITIALIZED, MEASUREMENT_IN_PROGRESS });
        parameters.add(new Object[] { INITIALIZED, RESETTING });

        parameters.add(new Object[] { MEASUREMENT_IN_PROGRESS, MEASUREMENT_STOPPED });
        parameters.add(new Object[] { MEASUREMENT_IN_PROGRESS, ERROR });

        parameters.add(new Object[] { MEASUREMENT_STOPPED, RESETTING });

        parameters.add(new Object[] { RESETTING, RESET });
        parameters.add(new Object[] { RESETTING, ERROR });

        parameters.add(new Object[] { RESET, MEASUREMENT_IN_PROGRESS });

        parameters.add(new Object[] { ERROR, RESETTING });
