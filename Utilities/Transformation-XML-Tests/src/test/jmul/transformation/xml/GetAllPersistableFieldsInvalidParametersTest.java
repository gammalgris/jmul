...
public class GetAllPersistableFieldsInvalidParametersTest {
     ...
     * @param anInput2
     */
    public GetAllPersistableFieldsInvalidParametersTest(Class anInput1, Class anInput2) {
    ...
    public void testGetAllPersistableFields() {
        ...
        TransformationHelper.getAllPersistableFields(input1, input2);
    }
...
class AClassB extends ASuperclassA {
