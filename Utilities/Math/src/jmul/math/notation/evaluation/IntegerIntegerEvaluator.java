...
import jmul.math.notation.comparators.IntegerEqualsComparator;
import jmul.math.notation.comparators.IntegerGreaterThanComparator;
import jmul.math.notation.comparators.IntegerLesserThanComparator;
import jmul.math.notation.comparators.NumberComparator;


/**
 * An implementation of an evaluator that evaluates expressions with two integer numbers.
 *
 * @author Kristian Kutin
 */
public class IntegerIntegerEvaluator extends ExpressionEvaluatorBase {

    /**
     * A comparator.
     */
    private static final NumberComparator EQUALS_COMPARATOR = new IntegerEqualsComparator();

    /**
     * A comparator.
     */
    private static final NumberComparator GREATER_THAN_COMPARATOR = new IntegerGreaterThanComparator();

    /**
     * A comparator.
     */
    private static final NumberComparator LESSER_THAN_COMPARATOR = new IntegerLesserThanComparator();

    /**
     * The default constructor.
     */
    public IntegerIntegerEvaluator() {
