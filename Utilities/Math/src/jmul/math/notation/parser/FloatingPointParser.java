...
/**
 * An implementation of a number parser that parses floating point numbers (as well as numbers
 * in scientific notation) provided as string.
 *
 * @author Kristian Kutin
 */
public class FloatingPointParser implements NumberParser {
