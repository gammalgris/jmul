...
public class InitializationExceptionValidParametersTest {
     ...
     * @param aCause
     */
    public InitializationExceptionValidParametersTest(String aMessage, Throwable aCause) {
    ...
    public void testInstantiation2() {
        ...
        InitializationException exception = new InitializationException(message, cause);
        assertEquals(message, exception.getMessage());
