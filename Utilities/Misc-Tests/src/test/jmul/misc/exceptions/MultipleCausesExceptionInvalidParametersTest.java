...
public class MultipleCausesExceptionInvalidParametersTest {
     ...
     * @param someCauses
     */
    public MultipleCausesExceptionInvalidParametersTest(Throwable... someCauses) {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { new Throwable[] { } });
