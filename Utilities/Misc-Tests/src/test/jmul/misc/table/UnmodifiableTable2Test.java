...
/**
 * A collection of tests for unmodifiable tables.r>
 * <br>
 * <i>Note:<br>
 * The test data consists of a table with a header with gaps/ empty column names and with gaps/ empty data cells.</i>
 *
 * @author Kristian Kutin
 */
@UnitTest
public class UnmodifiableTable2Test {
    ...
    public void setUp() {
        ...
        table =
            new UnmodifiableTableImpl<Integer>(new String[] { "A", "", "C" },
