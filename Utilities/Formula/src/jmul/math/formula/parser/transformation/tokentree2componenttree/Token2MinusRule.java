...
import jmul.math.formula.parser.components.Minus;
 ...
 */
public class Token2MinusRule extends TransformationRuleBase {
     ...
     * @param aPriority
     */
    public Token2MinusRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (object instanceof Node) {
            ...
            return token.hasTrait(TokenTraits.MINUS);
        }
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        if (node.children() == 1) {
            ...
            return new Minus(leftComponent);
            ...
            return new Minus(leftComponent, rightComponent);
        }

        String message = String.format("The node (token=\"%s\") requires one or two child nodes!", token);
