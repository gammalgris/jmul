...
import jmul.math.formula.parser.components.Division;
 ...
 */
public class Token2DivisionRule extends TransformationRuleBase {
     ...
     * @param aPriority
     */
    public Token2DivisionRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (object instanceof Node) {
            ...
            return token.hasTrait(TokenTraits.DIVISION);
        }
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        return new Division(leftComponent, rightComponent);
    }
