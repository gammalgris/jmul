...
import jmul.math.formula.parser.components.Constant;
 ...
 */
public class Token2ConstantRule extends TransformationRuleBase {
     ...
     * @param aPriority
     */
    public Token2ConstantRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (object instanceof Node) {
            ...
            return token.hasTrait(TokenTraits.NUMBER);
        }
