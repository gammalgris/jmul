...
/**
 * This rule is for purposes of error handling.
 *
 * @author Kristian Kutin
 */
public class NoMatchingRule extends TransformationRuleBase {
     ...
     * @param aPriority
     */
    public NoMatchingRule(String anOrigin, String aDestination, int aPriority) {
