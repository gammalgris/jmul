...
import jmul.math.formula.parser.components.Modulo;
 ...
 */
public class Token2ModuloRule extends TransformationRuleBase {
     ...
     * @param aPriority
     */
    public Token2ModuloRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (object instanceof Node) {
            ...
            return token.hasTrait(TokenTraits.MODULO);
        }
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        return new Modulo(leftComponent, rightComponent);
    }
