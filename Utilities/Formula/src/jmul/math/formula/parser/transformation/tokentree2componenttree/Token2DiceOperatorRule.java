...
import jmul.math.formula.parser.components.DiceOperator;
 ...
 */
public class Token2DiceOperatorRule extends TransformationRuleBase {
     ...
     * @param aPriority
     */
    public Token2DiceOperatorRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (object instanceof Node) {
            ...
            return token.hasTrait(TokenTraits.DICE_OPERATOR);
        }
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        return new DiceOperator(leftComponent, rightComponent);
    }
