...
import jmul.math.formula.parser.components.Plus;
 ...
 */
public class Token2PlusRule extends TransformationRuleBase {
     ...
     * @param aPriority
     */
    public Token2PlusRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (object instanceof Node) {
            ...
            return token.hasTrait(TokenTraits.PLUS);
        }
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        if (node.children() == 1) {
            ...
            return new Plus(leftComponent, rightComponent);
        }
