...
import jmul.math.random.DiceFactory;
 ...
 */
public class DiceOperator extends ComponentBase implements Operator {
     ...
     */
    public DiceOperator(Component... someComponents) {
    ...
    private static Component[] check(Component... someComponents) {
        ...
        } else if (someComponents.length != 2) {

            String message =
                String.format("The parameter array is expected to have two elements only (%s)!",
    ...
    public int calculate() {
        ...
        Dice dice = DiceFactory.createDice(left.calculate(), right.calculate());
