...
/**
 * This class contains tests to check if the filename filter works properly.
 *
...
public class ExactFileNameFilterTest extends FileFilterTestBase {
    ...
    /**
     * Tests if the filter correctly recognizes a file with the expected filename.
    ...
    public void testFilterOnInvalidFileName() {
        ...
        File path = new File("testdata-io\\file2.bat");
        boolean actualResult = filter.accept(path);
