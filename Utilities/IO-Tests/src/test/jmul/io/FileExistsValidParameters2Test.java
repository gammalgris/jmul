...
public class FileExistsValidParameters2Test {
     ...
     */
    public FileExistsValidParameters2Test(File aPath, boolean theExpectedResult) {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { new File("testdata-io\\file1.txt"), true });
        parameters.add(new Object[] { new File("testdata-io\\doesnt_exist.txt"), false });
        parameters.add(new Object[] { new File("testdata-io\\folder1"), false });
        parameters.add(new Object[] { new File(""), false });
