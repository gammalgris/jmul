...
public class InvalidConversionTest {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { 15d, "kg", 15000d, "s" });
        parameters.add(new Object[] { 100d, "g", 0.1d, "h" });
        parameters.add(new Object[] { 0.01d, "kg", 10000d, "Hallo Welt!" });
     ...
     */
    public InvalidConversionTest(double initialValue, String origin, double expectedValue, String destination) {
