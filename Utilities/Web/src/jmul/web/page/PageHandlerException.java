...
public class PageHandlerException extends RuntimeException {
     ...
     */
    public PageHandlerException(String aMessage, Throwable aCause) {
     ...
     *        a message which provides details about the exception
     */
    public PageHandlerException(String aMessage) {
     ...
     *        the cause of this exception
     */
    public PageHandlerException(Throwable aCause) {
