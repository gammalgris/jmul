 ...
 */
public class Xml2DateRule extends TransformationRuleBase implements TransformationCommons {
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        if (!element.existsAttribute(FORMAT_ATTRIBUTE_TAGNAME)) {

            StringConcatenator message =
                new StringConcatenator("The element \"", element.getName(),
                                       "\" is missing the attribute \"",
                                       FORMAT_ATTRIBUTE_TAGNAME, "\"!");
            throw new TransformationException(message.toString());
        }
        ...
        String formatString = element.getAttribute(FORMAT_ATTRIBUTE_TAGNAME);
