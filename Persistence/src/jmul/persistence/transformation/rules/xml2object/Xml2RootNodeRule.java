 ...
 */
public class Xml2RootNodeRule extends TransformationRuleBase implements TransformationCommons {
     ...
     *        a rule priority
     */
    public Xml2RootNodeRule(String anOrigin, String aDestination,
                            int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        if (!Document.class.isInstance(target) &&
            ...
            return (!element.existsAttribute(ID_ATTRIBUTE_TAGNAME) &&
                    element.existsSubelement(FIELD_ELEMENT_TAGNAME));
        }
