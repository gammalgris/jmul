 ...
 */
public class ID2XmlRule extends TransformationRuleBase implements TransformationCommons {
     ...
     *        a rule priority
     */
    public ID2XmlRule(String anOrigin, String aDestination, int aPriority) {
    ...
    public boolean isApplicable(TransformationParameters someParameters) {
        ...
        return ID.class.isInstance(someParameters.getObject());
    }
    ...
    public Object transform(TransformationParameters someParameters) {
        ...
        element.setAttribute(VALUE_ATTRIBUTE_TAGNAME, value.toString());
