...
class DefinitionRepositoryImpl implements DefinitionRepository {
    ...
    private void init() {
        ...
        for (Class primitiveType : primitiveTypes) {
            ...
            ClassIdentifier identifier =
                createClassIdentifier(primitiveType.getName());

            ClassDefinition wrapper =
                new ClassDefinitionImpl(identifier, primitiveType);
        ...
        try {
            ...
            for (int a = 0; a < primitiveWrappers.length; a++) {
                ...
                ClassDefinition correspondingPrimitiveTypeWrapper =
                    getClassWrapper(correspondingPrimitiveType);

                ClassIdentifier identifier =
                    createClassIdentifier(primitiveWrapper.getName());
    ...
    public ClassDefinition getClassWrapper(String aClassname,
        ...
        ClassIdentifier identifier =
            createClassIdentifier(aClassname, anAlternateClasspath);
        return getClassWrapper(identifier);
    }
    ...
    private void addWrapper(ClassIdentifier anIdentifier,
        ...
        ClassDefinition wrapper =
            createClassWrapper(anIdentifier, aCorrespondingPrimitiveType);
